...
- :func:`~rust_primes.func.list_prime` - Return a list of primes within a provided value;
- :func:`~rust_primes.func.count_prime` - Count the number of primes within a provided value.
"""
